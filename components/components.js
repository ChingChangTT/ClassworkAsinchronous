export const CardComponent = (product) => {
  ...
  return `
    <div id="product-${id}" class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      ...
      <div class="px-5 pb-5">
        ...
        <div class="mt-2 text-sm text-gray-600 dark:text-gray-400">
          <span class="merchant">Merchant: ${phone}</span> |
          <span class="provider">Provider: ${username}</span>
        </div>
      </div>
    </div>
  `;
